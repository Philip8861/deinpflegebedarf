 ...
 * Build: 2026-07-16-live-fix-d (direktes Formular-Submit, kein fetch-Bot-Trigger)
 */
(function () {
  'use strict';
  ...
  function initWithdrawal(root) {
    ...
    form.addEventListener('submit', function (ev) {
      ...
      try {
        sendCustomerEmailWebhook(root, webhookPayload);
      } catch (e) {}
      try {
      ...
      // Nativ absenden — kein fetch(), damit Shopifys Bot-Schutz (unabhängig
      // vom hCaptcha-Schalter in den Einstellungen) nicht fälschlich greift.
      form.submit();
    });
