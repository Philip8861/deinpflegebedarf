...
CATEGORIES = [
    ...
    ("Versand und Lieferung", [
        ...
        ("Wie lange dauert die Lieferung?", "<p>Die Lieferzeit beträgt in der Regel 2 bis 5 Werktage nach Zahlungseingang bzw. nach erfolgreicher Zahlungsbestätigung. Bei einzelnen Produkten kann eine abweichende Lieferzeit gelten. In diesem Fall wird diese direkt beim Produkt oder im Bestellprozess angezeigt.</p>"),
        ("Wie hoch sind die Versandkosten?", f'<p>Die Versandkosten werden im Warenkorb und im Checkout vor Abschluss der Bestellung deutlich angezeigt.</p><p>Standardversand innerhalb Deutschlands: <strong>4,90 €</strong></p><p>Ab einem Bestellwert von <strong>150,00 €</strong> liefern wir versandkostenfrei.</p><p>Weitere Details finden Sie auf der Seite <a href="{V}">Versand &amp; Zahlung</a>.</p>'),
    ...
    ("Zahlung", [
        ("Welche Zahlungsarten bietet ihr an?", "<p>In unserem Online-Shop stehen Ihnen folgende Zahlungsarten zur Verfügung:</p><ul><li>Klarna</li><li>PayPal</li><li>Visa</li><li>Mastercard</li><li>Google Pay</li></ul><p>Die tatsächlich verfügbaren Zahlungsarten werden Ihnen im Checkout angezeigt.</p>"),
        ...
        ("Speichert ihr meine Kreditkartendaten?", "<p>Nein. Wir speichern keine vollständigen Kreditkartendaten. Die Zahlungsabwicklung erfolgt über die eingebundenen Zahlungsdienstleister bzw. die technische Zahlungsinfrastruktur des Shops.</p>"),
    ...
    ("Pflegehilfsmittel, Pflegebox und Pflegekasse", [
        ...
        ("Bietet ihr eine Pflegebox an?", "<p>Unser Sortiment richtet sich an Menschen, die Pflegebedarf für den Alltag suchen. Ob und in welcher Form Pflegeboxen oder abrechenbare Pflegehilfsmittel angeboten werden, entnehmen Sie bitte den aktuellen Informationen im Shop oder kontaktieren Sie uns direkt.</p>"),
    ...
    ("Kundenkonto und Datenschutz", [
        ...
        ("Nutzt ihr Shopify?", "<p>Ja. Unser Online-Shop wird über Shopify betrieben. Shopify stellt die technische Shop-Plattform bereit, über die Produkte angezeigt, Warenkörbe verwaltet und Bestellungen abgewickelt werden.</p>"),
        ("Nutzt ihr Shopify-Apps?", "<p>Wir nutzen Shopify als Shop-Plattform und Shopify Flow zur Automatisierung interner Shop-Prozesse. Nach aktuellem Stand nutzen wir keine weiteren zusätzlichen Shopify-Apps, die über Shopify Flow und die Standardfunktionen des Shops hinaus personenbezogene Daten verarbeiten.</p>"),
    ...
    ("Ratgeber und Pflegewissen", [
        ...
        ("Warum schreibt ihr über Pflegegrad, Pflegehilfsmittel und Inkontinenz?", "<p>Diese Themen betreffen viele Menschen im Pflegealltag. Unser Ziel ist es, wichtige Informationen verständlich und alltagsnah zu erklären, damit Betroffene und Angehörige schneller passende Hilfe und passende Produkte finden.</p>"),
